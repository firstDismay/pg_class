...
namespace pg_class.pg_classes
{
    ...
    public partial class position
    {
        ...
        /// document_by_id_position
        /// </summary>
        public List<document> document_list_get(Boolean object_on, Boolean recursive_on, Boolean Extended = false)
        {
            if (Extended)
            {
                return Manager.document_ext_by_id_position(this, object_on, recursive_on);
            }
            else
            {
                return Manager.document_by_id_position(this, object_on, recursive_on);
            }
        }
