...
namespace pg_class.pg_classes.calendar
{
    ...
    /// </summary>
    public partial class plan_given_range_plan_link
    {
        ...
        /// </summary>
        protected plan_given_range_plan_link()
        {
            imagekey = "plan_given_range_plan_link_us";
            selectedimagekey = "plan_given_range_plan_link_s";
        }
        /// <summary>
        /// Полный конструктор класса для возврата данных существующих записей через строку таблицы 
        /// </summary>
        public plan_given_range_plan_link(System.Data.DataRow row) : this()
        {

            if (row.Table.TableName == "vplan_given_range_plan_link")
            {
                id = (Int64)row["id"];
