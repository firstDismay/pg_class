...
namespace pg_class.pg_classes.calendar
{
    ...
    /// Класс классов
    /// </summary>
    public partial class plan_given_range_plan_link : iEntity
    {
        /// <summary>
        ...
        public eEntity EntityEnum
        {
            get
            {
                return eEntity.plan_given_range_plan_link;
            }
        }
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("plan_given_range_plan_link_{0}", id);
            }
        }
        ...
        public Type EntityType
        {
            get
            {
                return typeof(plan_given_range_plan_link);
            }
        }
