...
namespace pg_class.pg_classes
{
    ...
    /// Класс классов
    /// </summary>
    public partial class prop_enum_val : iEntity
    {
        /// <summary>
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("prop_enum_val_{0}", id_prop_enum_val);
            }
        }
