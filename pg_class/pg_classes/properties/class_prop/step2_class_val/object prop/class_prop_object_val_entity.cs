...
namespace pg_class.pg_classes
{
    ...
    /// Класс сущностей
    /// </summary>
    public partial class class_prop_object_val : iEntity
    {
        /// <summary>
        ...
        public eEntity EntityEnum
        {
            get
            {
                return eEntity.class_prop_object_val;
            }
        }
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("class_prop_object_val_id{0}_ts{1}", id, timestamp_class);
            }
        }
