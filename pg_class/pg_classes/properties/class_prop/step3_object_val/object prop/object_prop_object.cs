...
namespace pg_class.pg_classes
{
    ...
    public partial class object_prop
    {
        ...
        {
            return Manager.object_prop_object_val_set_new(this, Class_real, Unit_conversion_rule, iquantity);
        }
        ...
        {
            return Manager.object_prop_object_val_set(this, Object_Val, icquantity);
        }
        #endregion
