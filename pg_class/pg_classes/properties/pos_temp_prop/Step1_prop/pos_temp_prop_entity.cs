...
{
    /// <summary>
    /// Реализация интерфейса сущности
    /// </summary>
    public partial class pos_temp_prop : iEntity
    {
        /// <summary>
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("pos_temp_prop{0}", id);
            }
        }
