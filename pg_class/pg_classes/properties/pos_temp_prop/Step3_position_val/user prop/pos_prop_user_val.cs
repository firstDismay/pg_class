...
{
    /// <summary>
    /// Класс значение пользовательского свойства позиции
    /// </summary>
    public partial class position_prop_user_val
    {
        ...
        /// </summary>
        protected position_prop_user_val()
        {
        ...
        /// </summary>
        public position_prop_user_val(System.Data.DataRow row) : this()
        {

            entitysource = eEntitySource.Server;
            switch (row.Table.TableName)
            {
                case "vposition_prop_user_big_val":
                    ...
                    break;
                case "vposition_prop_user_small_val":
        ...
        {
            return Manager.position_prop_user_val_is_actual(this);
        }
        ...
        public void Update()
        {
            if (on_change )
            {
                ...
                {
                    Manager.position_prop_user_val_add(this);
                }
                else
                {
                    Manager.position_prop_user_val_upd(this);
                }
                Refresh();
                on_change = false;
            }
