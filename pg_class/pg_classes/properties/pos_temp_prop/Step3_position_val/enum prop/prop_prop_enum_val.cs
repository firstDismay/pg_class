...
{
    /// <summary>
    /// Класс данных значения свойства позиции типа перечисление
    /// </summary>
    public partial class position_prop_enum_val
    {
        ...
        /// </summary>
        protected position_prop_enum_val()
        {
            on_change = false;
        ...
        /// </summary>
        public position_prop_enum_val(System.Data.DataRow row) : this()
        {

            if (row.Table.TableName == "vposition_prop_enum_val")
            {
        ...
        /// <summary>
        /// Идентификатор свойства шаблона позиции носителя свойства
        /// </summary>
        ...
        {
            return Manager.position_prop_enum_val_is_actual(this);
        }
        ...
        public void Update()
        {
            if (on_change)
            {
                ...
                {
                    Manager.position_prop_enum_val_add(this);
                }
                else
                {
                    Manager.position_prop_enum_val_upd(this);
                }
                Refresh();
                on_change = false;
            }
        ...
        {
            position_prop_enum_val temp;
            Boolean Result = false;
            temp = Manager.position_prop_enum_val_by_id_prop(this);
        ...
        /// </summary>
        public pos_temp GetPosTempCarrier()
        {
