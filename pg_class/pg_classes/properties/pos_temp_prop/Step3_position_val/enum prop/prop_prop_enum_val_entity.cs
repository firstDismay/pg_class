...
namespace pg_class.pg_classes
{
    ...
    /// Класс классов
    /// </summary>
    public partial class position_prop_enum_val : iEntity
    {
        /// <summary>
        ...
        public eEntity EntityEnum
        {
            get
            {
                return eEntity.position_prop_enum_val;
            }
        }
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("prop_enum_val{0}", id_prop_enum_val);
            }
        }
        ...
        public Type EntityType
        {
            get
            {
                return typeof(position_prop_enum_val);
            }
        }
