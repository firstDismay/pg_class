...
{
    /// <summary>
    /// Класс данных значения пользовательского свойства шаблона
    /// </summary>
    public partial class pos_temp_prop_user_val
    {
        ...
        /// </summary>
        protected pos_temp_prop_user_val()
        {
            imagekey = "pos_temp_prop_user_val_us";
        ...
        /// </summary>
        public pos_temp_prop_user_val(System.Data.DataRow row) : this()
        {

            entitysource = eEntitySource.Server;
            switch (row.Table.TableName)
            {
                case "vpos_temp_prop_user_big_val":
                    ...
                    break;
                case "vpos_temp_prop_user_small_val":
        ...
        public void Update()
        {
            ...
            if (on_change)
            {
                Manager.pos_temp_prop_user_val_set(this);
                Refresh();
                on_change = false;
            }
        }
        ...
        public Boolean Refresh()
        {
            ...
            pos_temp_prop_user_val temp = null;
            Boolean Result = false;

            temp = Manager.pos_temp_prop_user_val_by_id_prop(this);
            if (temp != null)
            {
