...
namespace pg_class.pg_classes
{
    ...
    /// Класс сущностей
    /// </summary>
    public partial class pos_temp_prop_object_val : iEntity
    {
        /// <summary>
        ...
        public eEntity EntityEnum
        {
            get
            {
                return eEntity.pos_temp_prop_object_val;
            }
        }
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("pos_temp_prop_object_val_id{0}", Id_pos_temp);
            }
        }
