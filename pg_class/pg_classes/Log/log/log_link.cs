...
namespace pg_class.pg_classes
{
    ...
    public partial class log
    {
        ...
        #region ВЫБРАТЬ
        List<log_link> log_link_list;
        /// <summary>
        /// Лист ссылок документа по идентификатору документа
        /// </summary>
        public List<log_link> log_link_list_get(Boolean DirectRequest = true)
        {
            if (DirectRequest || log_link_list == null)
            {
                log_link_list = Manager.log_link_by_id_document(Id);
            }
        ...
        /// </summary>
        public log_link log_link_by_entity( user User)
        {
            return Manager.log_link_by_entity(this.Id, User.EntityID, User.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity(pos_temp Pos_temp)
        {
            return Manager.log_link_by_entity(this.Id, Pos_temp.EntityID, Pos_temp.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity(pos_temp_prop Pos_temp_prop)
        {
            return Manager.log_link_by_entity(this.Id, Pos_temp_prop.EntityID, Pos_temp_prop.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity( position Position)
        {
            return Manager.log_link_by_entity(this.Id, Position.EntityID, Position.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity( position_prop Position_prop)
        {
            return Manager.log_link_by_entity(this.Id, Position_prop.EntityID, Position_prop.Id_position_prop, Position_prop.Id_position_carrier);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity( object_general Object_general)
        {
            return Manager.log_link_by_entity(this.Id, Object_general.EntityID, Object_general.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity( object_prop Object_prop)
        {
            return Manager.log_link_by_entity(this.Id, Object_prop.EntityID, Object_prop.Id_class_prop, Object_prop.Id_object_carrier);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity(group Group)
        {
            return Manager.log_link_by_entity(this.Id, Group.EntityID, Group.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity(vclass Class)
        {
            return Manager.log_link_by_entity(this.Id, Class.EntityID, Class.Id, -1);
        }

        /// <summary>
        /// Ссылка на документ по идентификатору сущности
        /// </summary>
        public log_link log_link_by_entity(class_prop Class_prop)
        {
            return Manager.log_link_by_entity(this.Id, Class_prop.EntityID, Class_prop.Id, -1);
        }
        #endregion
        #endregion*/
    }
