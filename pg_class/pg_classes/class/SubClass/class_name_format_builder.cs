        ...
        public class_name_format_builder(vclass Class) : this()
        {
            ...
            else
            {
                throw new ArgumentOutOfRangeException(
                    "Указанный класс не допускает определение формата наименования объектов, требуется активное представление абстрактного класса, содержащего вещественные классы !");
            }
        }
        #endregion
        ...
        public void FormatAppend(class_prop Class_prop)
        {
            if (format_builder != null && class_prop_list_builder != null)
            {
                if (Class_prop != null)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("Формат имен объектов класса не создан, используйте метод FormatNew!");
                    }
                }
            }
            else
            ...
            if (format_builder != null && class_prop_list_builder != null)
            {
                if (format_is_create)
                {
                    if (Step_list != null)
                    {
                        ...
                        {
                            throw new ArgumentOutOfRangeException(
                                "Формат не содержит данных для удаления!");
                        }
                    }
                }
                else
