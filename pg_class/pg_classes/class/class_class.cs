...
namespace pg_class.pg_classes
{
    public partial class vclass
    {
        ...
        /// <summary>
        /// Экспорт наследующих представлений классов
        /// </summary>
        public Byte[] Class_child_list_export(eBaseExportFormat ExportFormat)
        {
            Byte[] Result = null;
            switch (ExportFormat)
            {
                ...
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_by_id_parent(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_with_prop_by_id_parent_to_excel(this);
                    break;
            }
            return Result;
        }
        ...
        /// <summary>
        /// Команда экспорта наследующих представлений классов
        /// </summary>
        public pg_commands.command_export Class_child_list_command_export(eBaseExportFormat ExportFormat)
        {
            pg_commands.command_export Result = null;
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_by_id_parent_command_export(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_with_prop_by_id_parent_to_excel_get_command(this);
                    break;
            }
            return Result;
        }
        ...
        /// <summary>
        /// Экспорт наследующих представлений вещественных классов
        /// </summary>
        public Byte[] Class_act_real_list_export(eBaseExportFormat ExportFormat)
        {
            Byte[] Result = null;
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_real_by_id_parent(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_real_with_prop_by_id_parent_to_excel(this);
                    break;
            }
            return Result;
        }
        ...
        /// <summary>
        /// Команда экспорта наследующих представлений вещественных классов
        /// </summary>
        public pg_commands.command_export Class_act_real_list_command_export(eBaseExportFormat ExportFormat)
        {
            pg_commands.command_export Result = null;
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_real_by_id_parent_command_export(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_real_with_prop_by_id_parent_to_excel_get_command(this);
                    break;
            }
            return Result;
        }
