...
namespace pg_class.pg_classes
{
    public partial class group
    {
        ...
        /// </summary>
        public Byte[] Class_act_base_list_export(eBaseExportFormat ExportFormat)
        {
            Byte[] Result = null;
            switch (ExportFormat)
            {
                ...
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_by_id_group(this.Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_with_prop_by_id_group_to_excel(this);
                    break;
            }
            return Result;
        }
        ...
        /// </summary>
        public pg_commands.command_export Class_act_base_list_command_export(eBaseExportFormat ExportFormat)
        {
            ...
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_by_id_group_command_export(this.Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_with_prop_by_id_group_to_excel_get_command(this);
                    break;
            }
            return Result;
        }
        ...
        public Byte[] Class_act_real_list_export(eBaseExportFormat ExportFormat)
        {
            ...
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_real_by_id_group(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_real_with_prop_by_id_group_to_excel(this);
                    break;
            }
            return Result;
        }
        ...
        public pg_commands.command_export Class_act_real_list_command_export(eBaseExportFormat ExportFormat)
        {
            ...
            switch (ExportFormat)
            {
                case eBaseExportFormat.TableEntity:
                case eBaseExportFormat.ViewEntity:
                    Result = Manager.class_act_real_by_id_group_command_export(Id, ExportFormat);
                    break;
                case eBaseExportFormat.ReportEntity:
                case eBaseExportFormat.ReportEntityWithProp:
                    Result = Manager.export_class_act_real_with_prop_by_id_group_to_excel_get_command(this);
                    break;
            }
            return Result;
        }
