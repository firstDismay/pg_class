...
namespace pg_class.pg_classes
{
    ...
    public partial class group
    {
        ...
        /// document_by_id_group
        /// </summary>
        public List<document> document_list_get(Boolean class_on, Boolean object_on, Boolean recursive_on, Boolean Extended = false)
        {
            if (Extended)
            {
                return Manager.document_ext_by_id_group(this, class_on, object_on, recursive_on);
            }
            else
            {
                return Manager.document_by_id_group(this, class_on, object_on, recursive_on);
            }
        }
        #endregion
