...
namespace pg_class.pg_classes
{
    ...
    /// Класс классов
    /// </summary>
    public partial class pos_temp_nested_rule : iEntity
    {
        /// <summary>
        ...
        public String EntityKey
        {
            get
            {
                return String.Format("pos_temp{0}_nested_rule{1}", id_pos_temp, id_pos_temp_nested);
            }
        }
