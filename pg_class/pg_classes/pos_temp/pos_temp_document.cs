...
namespace pg_class.pg_classes
{
    ...
    public partial class pos_temp
    {
        ...
        /// document_by_id_pos_temp
        /// </summary>
        public List<document> document_list_get(Boolean position_on, Boolean object_on, Boolean recursive_on, Boolean Extended = false)
        {
            if (Extended)
            {
                return Manager.document_ext_by_id_pos_temp(this, position_on, object_on, recursive_on);
            }
            else
            {
                return Manager.document_by_id_pos_temp(this, position_on, object_on, recursive_on);
            }
        }
