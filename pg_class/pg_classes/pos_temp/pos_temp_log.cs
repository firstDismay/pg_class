...
namespace pg_class.pg_classes
{
    ...
    public partial class pos_temp
    {
        ...
        /// </summary>
        public List<log> log_list_get(Boolean position_on, Boolean object_on, Boolean recursive_on)
        {
            return Manager.log_by_id_pos_temp(this, position_on, object_on, recursive_on);
        }
        #endregion
        #endregion
    }
