...
{
    /// <summary>
    /// Класс правила разрешения уровня 1 группа на шаблон определяющего доступность вложения объектов в позиции
    /// </summary>
    public partial class rulel1_group_on_pos_temp
    {
        ...
        /// </summary>
        protected rulel1_group_on_pos_temp()
        {
        }
        /// <summary>
        /// Полный конструктор класса для возврата данных существующих записей через строку таблицы 
        /// </summary>
        public rulel1_group_on_pos_temp(System.Data.DataRow row) : this()
        {
            if (row.Table.TableName == "vrulel1_group_on_pos_temp")
            {
