...
{
    /// <summary>
    /// Класс снимок разрешающего правила уровня 2 класс на позицию (свет Эарендила)
    /// </summary>
    public partial class rulel2_class_snapshot_on_position
    {
        ...
        /// </summary>
        protected rulel2_class_snapshot_on_position()
        {
        }
        /// <summary>
        /// Полный конструктор класса для возврата данных существующих записей через строку таблицы 
        /// </summary>
        public rulel2_class_snapshot_on_position(System.Data.DataRow row) : this()
        {
            if (row.Table.TableName == "vrulel2_class_snapshot_on_position")
            {
        ...
        /// <summary>
        /// Штамп времени класса включенного в разрешающее правило уровня 2 класс на позицию
        /// </summary>
