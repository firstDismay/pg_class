...
namespace pg_class
{
    public partial class manager
    {
        ...
        /// Лист объектов по идентификатору типа данных свойств концепции
        /// </summary>
        public List<object_general> object_by_id_prop_data_type(con_prop_data_type Con_prop_data_type, Boolean Extended = false)
        {
            List<object_general> Result;
            if (Extended)
            {
                Result = object_ext_by_id_prop_data_type(Con_prop_data_type);
            }
            else
            {
                Result = object_by_id_prop_data_type(Con_prop_data_type);
            }
            return Result;
        }
