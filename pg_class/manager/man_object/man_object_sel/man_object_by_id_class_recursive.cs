...
namespace pg_class
{
    public partial class manager
    {
        ...
        /// </summary>
        public List<object_general> object_by_id_class_recursive(vclass Class, Boolean Extended = false)
        {
            List<object_general> Result;
            if (Extended)
            {
                Result = object_ext_by_id_class_recursive(Class);
            }
            else
            {
                Result = object_by_id_class_recursive(Class);
            }
            return Result;
        }
