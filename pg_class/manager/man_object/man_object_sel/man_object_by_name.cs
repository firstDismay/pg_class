...
namespace pg_class
{
    public partial class manager
    {
        ...
        /// Лист представлений объектов по маске имени объекта в указанной концепции
        /// </summary>
        public List<object_general> object_by_name(String iname, conception Conception, Boolean on_inside)
        {
            return object_by_name(iname, Conception.Id, on_inside);
        }

        /// <summary>
        /// Лист представлений объектов по маске имени объекта в указанной концепции
        /// </summary>
        public List<object_general> object_by_id_position(String iname, Int64 iid_conception, Boolean on_inside, Boolean Extended = false)
        {
            List<object_general> Result;
            if (Extended)
            {
                Result = object_ext_by_name(iname,iid_conception, on_inside);
            }
            else
            {
                Result = object_by_name(iname, iid_conception, on_inside);
            }
            return Result;
        }
