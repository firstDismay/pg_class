...
{
    /// <summary>
    /// Аргумент событий изменения элемента назначения типа данных на концепцию
    /// </summary>
    public class Con_Prop_Data_TypeChangeEventArgs : EventArgs
    {
        #region КОНСТРУКТОРЫ КЛАССА
        /// <summary>
        /// Основной конструктор класса аргумента события
        /// </summary>
        public Con_Prop_Data_TypeChangeEventArgs(Int64 Id_Conception, Int32 Id_Prop_Data_Type, eActionRuleList Action) : base()
        {
            action = Action;
