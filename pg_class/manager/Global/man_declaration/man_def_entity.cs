namespace pg_class
{
    ...
    public enum eEntityState
    {
        ...
        NotFound = 1,
        /// <summary>
        /// Текущее представление Сущности не соответствует данным в базе, требуется обновление данных
        /// </summary>
        NotActual = 2,
        /// <summary>
        /// Текущее представление Сущности соответствует данным в базе, обновление данных не требуется
        /// </summary>
        Actual = 3,
        /// <summary>
        /// Текущее представление Сущности соответствует данным в базе, количественный состав потомков изменен, требуется обновление данных сущности
        /// </summary>
