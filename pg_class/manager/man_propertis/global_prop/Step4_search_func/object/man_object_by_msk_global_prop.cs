...
=======
        ...
        public List<object_general> object_by_global_prop(Int64 iid_global_prop,
>>>>>>> e7d329e (Изменение наименований методов поиска объектов по глобальным свойствам с аргументом метода поиска)
                                                                        eSearchMethods search_method, String valreq, String valmin, String valmax)
        {
            ...
            cmdk = CommandByKey("object_by_global_prop");
            if (cmdk != null)
            {
                if (!cmdk.Access)
                {
...
=======
        ...
        /// <returns>Лист объектов</returns>
        /// <exception cref="AccessDataBaseException"></exception>
        public List<object_general> object_by_global_prop(global_prop Global_prp,
>>>>>>> e7d329e (Изменение наименований методов поиска объектов по глобальным свойствам с аргументом метода поиска)
                                                                        eSearchMethods search_method, String valreq, String valmin, String valmax)
        {
            return object_by_global_prop(Global_prp.Id, search_method, valreq, valmin, valmax);
        }
        ...
        /// </summary>
        public Boolean object_by_global_prop(out eAccess Access)
        {
