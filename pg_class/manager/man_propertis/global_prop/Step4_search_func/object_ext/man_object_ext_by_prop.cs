...
namespace pg_class
{
    public partial class manager
    {
        ...
        public List<object_general> object_ext_by_prop(PropSearchСondition prop_search_condition, Int64 iid_position = -1)
        {
            PropSearchСondition[] array_prop = new PropSearchСondition[1];
            array_prop[0] = prop_search_condition;
            return object_ext_by_array_prop(array_prop, iid_position);
        }
        ...
        /// </summary>
        public Boolean object_ext_by_prop(out eAccess Access)
        {
