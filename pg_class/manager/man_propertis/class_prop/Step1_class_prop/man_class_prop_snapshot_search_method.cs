...
namespace pg_class
{
    public partial class manager
    {
        ...
        /// </summary>
        public List<String> class_search_method_by_id_class_prop(Int64 iid_class_prop)
        {
            ...
            //=======================
            cmdk = CommandByKey("class_search_method_by_id_class_prop");
        ...
        /// Метод возвращает список методов сложного поиска по идентификатору свойства
        /// </summary>
        public List<eSearchMethods> class_search_method_by_id_class_prop2(Int64 iid_class_prop)
        {
            DataTable tsearch_method;
        ...
        /// Проверка прав доступа к методу
        /// </summary>
        public Boolean class_search_method_by_id_class_prop(out eAccess Access)
        {
            Boolean Result = false;
            Access = eAccess.NotFound;
            NpgsqlCommandKey cmdk;
